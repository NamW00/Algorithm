...
{
	// 왼쪽게 작다라고 한다면 왼쪽것을 먼저 인덱스에 넣어준다.
	// 만약 4개가 있다면 왼쪽 배열과 오른쪽배열의 왼쪽요소를 각각
	// left, right로 잡고 대입한 후에 left++, right++를 해줌으로써
	// 다음요소들을 비교해 배열에 대입해주면 된다.
...
#pragma region 합병 정렬
	...
	// 부분 리스트를 정렬한 다음, 두개의 정렬된 부분 리스트를
